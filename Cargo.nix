  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws-config" = rec {
        ...
        resolvedDefaultFeatures = [ "behavior-version-latest" "client-hyper" "rt-tokio" "rustls" ];
      };
      ...
      "aws-sdk-ec2" = rec {
        ...
        version = "1.225.0";
        edition = "2021";
        sha256 = "1rlq27fv905rm00q0fl4inl79p1j9yprnw9l4iypbr32nkmcy7gl";
        libName = "aws_sdk_ec2";
        authors = [
          "AWS Rust SDK Team <aws-sdk-rust@amazon.com>"
          "Russell Cohen <rcoh@amazon.com>"
        ...
        resolvedDefaultFeatures = [ "behavior-version-latest" "rt-tokio" "rustls" ];
      };
      "aws-sdk-sts" = rec {
      ...
      "rcgen" = rec {
        ...
        resolvedDefaultFeatures = [ "aws_lc_rs" "crypto" "pem" ];
      };
      "redox_syscall" = rec {
      ...
      "rsa" = rec {
        ...
        resolvedDefaultFeatures = [ "pem" "std" ];
      };
      "rustc-hash" = rec {
